...
def get_serializer(serializer):
  ...
  if serializer is None:
    ...
    raise ValueError(
        'serializer must be either a callable or one of {}'.format(
            list(_SERIALIZERS.keys())))
...
def get_deserializer(deserializer):
  ...
  if deserializer is None:
    ...
    raise ValueError(
        'deserializer must be either a callable or one of {}'.format(
            list(_DESERIALIZERS.keys())))
